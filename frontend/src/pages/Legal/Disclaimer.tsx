...
export const Disclaimer = () => {
    return (
        <PublicLayout showTicker={false}>
            <SEO title="Disclaimer" description="ShareSathi disclaimer — paper trading simulation only, not financial advice. Read our terms and limitations." canonical="/disclaimer" />
